...
module SDL
  ...
  def self.setup_hidapi_symbols(output_error = false)
    ...
    args = {
      ...
      :SDL_hid_write => [:pointer, :pointer, :ulong_long],
      :SDL_hid_read_timeout => [:pointer, :pointer, :ulong_long, :int],
      :SDL_hid_read => [:pointer, :pointer, :ulong_long],
      :SDL_hid_set_nonblocking => [:pointer, :int],
      :SDL_hid_send_feature_report => [:pointer, :pointer, :ulong_long],
      :SDL_hid_get_feature_report => [:pointer, :pointer, :ulong_long],
      :SDL_hid_get_input_report => [:pointer, :pointer, :ulong_long],
      :SDL_hid_close => [:pointer],
      :SDL_hid_get_manufacturer_string => [:pointer, :pointer, :ulong_long],
      :SDL_hid_get_product_string => [:pointer, :pointer, :ulong_long],
      :SDL_hid_get_serial_number_string => [:pointer, :pointer, :ulong_long],
      :SDL_hid_get_indexed_string => [:pointer, :int, :pointer, :ulong_long],
      :SDL_hid_get_device_info => [:pointer],
      :SDL_hid_get_report_descriptor => [:pointer, :pointer, :ulong_long],
      :SDL_hid_ble_scan => [:bool],
    }
    retvals = {
      :SDL_hid_init => :int,
      :SDL_hid_exit => :int,
