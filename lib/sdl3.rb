...
# SDL_shadercross
require_relative 'sdl3_shadercross.rb'

module SDL
  extend FFI::Library

  @@sdl3_import_done = false
  def self.load_lib(libpath, output_error: false, image_libpath: nil, ttf_libpath: nil, mixer_libpath: nil, sound_libpath: nil, shadercross_libpath: nil)
    ...
    unless @@sdl3_import_done
      ...
      begin
        ...
        shadercross_libpaths = Array(shadercross_libpath).compact
        lib_paths.concat(shadercross_libpaths)
        ...
        setup_shadercross_symbols(output_error) unless shadercross_libpaths.empty?
      rescue => error
