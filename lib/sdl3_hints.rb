...
module SDL
  ...
  HINT_ENABLE_STEAM_SCREEN_KEYBOARD = "SDL_ENABLE_STEAM_SCREEN_KEYBOARD"
  ...
  HINT_JOYSTICK_GAMEINPUT_RAW = "SDL_JOYSTICK_GAMEINPUT_RAW"
  ...
  HINT_VIDEO_X11_ENABLE_XSYNC_EXT = "SDL_VIDEO_X11_ENABLE_XSYNC_EXT"
