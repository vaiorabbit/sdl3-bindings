...
cmake -G "Unix Makefiles" -D CMAKE_BUILD_TYPE=Release -D BUILD_SHARED_LIBS=ON -D CMAKE_C_COMPILER=gcc -D SDL_OPENGLES=OFF -D SDLSHADERCROSS_SPIRVCROSS_SHARED=OFF -D SDLSHADERCROSS_VENDORED=OFF -D CMAKE_C_FLAGS_RELEASE="%COMMON_C_FLAGS%" -D CMAKE_CXX_FLAGS_RELEASE="%COMMON_CXX_FLAGS%" -D CMAKE_SHARED_LINKER_FLAGS="%COMMON_LINKER_FLAGS%" -D CMAKE_PREFIX_PATH=%CD%/../spirv_cross_prefix -D DirectXShaderCompiler_ROOT=../external/DirectXShaderCompiler-binaries ../
cmake --build .
